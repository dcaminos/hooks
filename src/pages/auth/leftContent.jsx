...
export default function LeftContent() {
  ...
  return (
    <Col lg={12} span={24} className="da-bg-color-primary-4 da-bg-color-dark-90 da-position-relative">
        ...
        <Col span={24}>
          <Row align="middle" justify="center" className="da-h-100">
            ...
            <Col xl={18} span={24} className="da-text-item da-text-center">
              <h2 className="da-text-color-primary-1 da-text-color-dark-0 da-mx-lg-16 da-mb-16">Very good works are  waiting for you 🤞</h2>
