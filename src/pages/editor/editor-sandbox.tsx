...
import { IntegrationResponse } from 'file:///integration-response'
...
async function runIntegration(request: IntegrationRequest): Promise<IntegrationResponse> {
    const response: IntegrationResponse = new IntegrationResponse(request.networkId, request.walletAddress)
    ...
    response.pushStakingPosition({
        stakedAmount: new BN(contractResponse[0].toString()),
        stakedToken,
        rewardAmount: new BN(contractResponse[1].toString()),
        rewardToken
    })
